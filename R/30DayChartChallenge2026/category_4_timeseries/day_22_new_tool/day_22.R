...
library(ggtext)
library(scales)
# TODO: añadir librería del nuevo tool que se quiera explorar
...
caption <- generate_caption(day = 22, source_text = source_text, config = config)
...
# --- 6. Guardar Gráfico ---
# output_file <- file.path(output_path, "day_22_new_tool.png")
# ggsave(filename = output_file, plot = gg,
#        width = 1200, height = 1200, units = "px", dpi = 150, bg = "white")
# message("Día 22 guardado en: ", normalizePath(output_file, mustWork = FALSE))
