# --- Day 20: Timeseries - Global Change ---
...
caption <- generate_caption(day = 20, source_text = source_text, config = config)
...
# --- 6. Guardar Gráfico ---
# output_file <- file.path(output_path, "day_20_global_change.png")
# ggsave(filename = output_file, plot = gg,
#        width = 1200, height = 1200, units = "px", dpi = 150, bg = "white")
# message("Día 20 guardado en: ", normalizePath(output_file, mustWork = FALSE))
