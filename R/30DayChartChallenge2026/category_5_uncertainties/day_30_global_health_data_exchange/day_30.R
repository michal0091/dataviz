# --- Day 30: Uncertainties - Global Health Data Exchange (Data Day) ---
# #30DayChartChallenge 2026
# Autor: Michal Kinel
# Fuente: Global Health Data Exchange - GHDx (https://ghdx.healthdata.org)
...
# Datos GHDx: https://ghdx.healthdata.org
# TODO: cargar datos
# dt <- fread("R/30DayChartChallenge2026/data/day_30.csv")

# --- 5. Crear Gráfico ---
source_text <- "IHME: Global Health Data Exchange (GHDx)"
plot_title    <- "TODO"
plot_subtitle <- "TODO"

caption <- generate_caption(day = 30, source_text = source_text, config = config)
...
# --- 6. Guardar Gráfico ---
# output_file <- file.path(output_path, "day_30_global_health_data_exchange.png")
# ggsave(filename = output_file, plot = gg,
#        width = 1200, height = 1200, units = "px", dpi = 150, bg = "white")
# message("Día 30 guardado en: ", normalizePath(output_file, mustWork = FALSE))
