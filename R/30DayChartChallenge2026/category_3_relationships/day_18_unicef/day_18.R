# --- Day 18: Relationships - UNICEF (Data Day) ---
# #30DayChartChallenge 2026
# Autor: Michal Kinel
# Fuente: UNICEF Data (https://data.unicef.org)
...
# Datos UNICEF: https://data.unicef.org
# TODO: cargar datos
# dt <- fread("R/30DayChartChallenge2026/data/day_18.csv")

# --- 5. Crear Gráfico ---
source_text <- "UNICEF Data: https://data.unicef.org"
plot_title    <- "TODO"
plot_subtitle <- "TODO"

caption <- generate_caption(day = 18, source_text = source_text, config = config)
...
# --- 6. Guardar Gráfico ---
# output_file <- file.path(output_path, "day_18_unicef.png")
# ggsave(filename = output_file, plot = gg,
#        width = 1200, height = 1200, units = "px", dpi = 150, bg = "white")
# message("Día 18 guardado en: ", normalizePath(output_file, mustWork = FALSE))
